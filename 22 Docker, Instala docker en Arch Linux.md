...
Paso 1, Instalamos con Pacman:

    sudo pacman -S docker

Paso 2: Instalamos herramientas requeridas:

    sudo pacman -S base-devel

Paso 3: Comprobamos con la version de docker:
...
Paso 5: Lo habilitamos:

    sudo systemctl enable docker.service

Paso 6: Añadimos Docker al grupo:
